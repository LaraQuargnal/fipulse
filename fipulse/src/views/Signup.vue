  ...
  <div class="signup">
    ...
    <div class="container">
      ...
      $t("signupName")
                ...
                <input type="text" v-model="nickname" class="form-control" id="exampleInputName"
      ...
      $t("loginEmailNote")
        ...
        $t("passwordLabel")
              ...
              <div class="form-group">
                <label for="exampleInputConfirmPassword" style="margin-top: 10px">{{ $t("confirmPassword") }}</label>
                <input type="passwordConfirm" v-model="passwordConfirm" class="form-control"
                  id="exampleInputConfirmPassword" :placeholder="$t('confirmPassword')" />
              </div>
              <button type="button" @click="signup" class="btn btn-primary" style="margin-top: 20px">
                {{ $t("signUp") }}
              </button>
